...
import { User, Mail, Calendar, Target, Edit3, Save, X, Dumbbell, Flame, TrendingUp } from 'lucide-react';
    ...
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '32px 16px' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 32, fontWeight: 700, color: 'var(--green)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <Field label="Benutzername" icon={User}>
            {editing ? (
              ...
              <span style={valueStyle}>{form.username || '—'}</span>
            )}
          </Field>
          ...
          {/* Weight */}
          <Field label="Gewicht (kg)" icon={TrendingUp}>
            {editing ? (
